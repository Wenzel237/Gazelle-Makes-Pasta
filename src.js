...
function updateGazelleImage() {
    if (sleepiness < 25) {
        document.getElementById("gazelle").src = "images/gazelle_0%_sleepy.png";
    } else if (sleepiness < 50) {
        document.getElementById("gazelle").src = "images/gazelle_25%_sleepy.png";
    } else if (sleepiness < 75) {
        document.getElementById("gazelle").src = "images/gazelle_50%_sleepy.png";
    } else if (sleepiness < 100) {
        document.getElementById("gazelle").src = "images/gazelle_75%_sleepy.png";
    } else {
        document.getElementById("gazelle").src = "images/gazelle_100%_sleepy.png";
    }
}
...
let sleepinessInterval = setInterval(increaseSleepiness, 2000);
let pastaPreparationInterval = setInterval(increasePastaPreparation, 1500);
>>>>>>> cebcc00 (Remove '%' from image file names)
